...
#ifndef EXCHANGE_CEXIO_H
#define EXCHANGE_CEXIO_H

#include "exchange.h"

class Exchange_CEXIO : public Exchange
{
	Q_OBJECT

public:
	void filterAvailableUSDAmountValue(double *amount);
    Exchange_CEXIO(QByteArray pRestSign, QByteArray pRestKey);
    ~Exchange_CEXIO();
